...
//	}
//
//	public MedicalHistory(Long memberId, Date dateOfAssessment, float bloodPressure, float heartRate, String allergies,
//			String medications, String chronicCondition, String familyMedicalHistory, String previousInjuryOrSurgery,
//			float fitnessLevel, Integer physicianContactNumber) {
//		super();
//		this.memberId = memberId;
//		this.dateOfAssessment = dateOfAssessment;
//		this.bloodPressure = bloodPressure;
